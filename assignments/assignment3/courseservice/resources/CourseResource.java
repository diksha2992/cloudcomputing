...
public class CourseResource {
	...
	public Course addCourse(AddCourseRequest addCourseRequest) {
		...
		if (addCourseRequest == null || addCourseRequest.getCourseId() == null
				|| addCourseRequest.getDepartment() == null || addCourseRequest.getNotificationTopic() == null) {
		...
		String notificationTopic = addCourseRequest.getNotificationTopic();
		Course course = new Course(courseId, department, notificationTopic);
